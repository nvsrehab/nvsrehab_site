...
?>
    ...
    */?>
        <!--</ul>-->
        <img class="footer_image" src="<?php bloginfo('stylesheet_directory'); ?>/images/CharitySealOfApproval.jpg" alt=""> 
        <img class="footer_image" src="<?php bloginfo('stylesheet_directory'); ?>/images/Carf.gif"  alt=""> 
      </div>
    </div>
    <?php wp_footer(); ?>
</body>
