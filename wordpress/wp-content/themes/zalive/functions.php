<?php 
  ...
  function zAlive_excerpt_more( $more ) {
    ...
    if(empty( $excerpt_text ) ){
      ...
      return '<a class="more-link" href="'. get_permalink( get_the_ID() ) . '">'. esc_attr($zAlive_options['excerpt_text']) .'</a>';
    }
  }
  ...
  function zAlive_getDefaultThemeOptions() {
    $options = array(
      ...
      'excerpt_length' => 300 ,              //excerpt length
      'excerpt_text' => '[Read More...]' ,              //Text to show when automatic excerpt enabled or use 'more' tag in posts
